...
const index$3 = require('./index-cbf0b508.js');
const ionicGlobal = require('./ionic-global-de702811.js');
const index$2 = require('./index-7ac84076.js');
const frameworkDelegate = require('./framework-delegate-d626a6e0.js');
...
const Modal = class {
  ...
  componentWillLoad() {
    ...
    this.inheritedAttributes = helpers.inheritAttributes(el, ['role']);
    /**
  ...
  render() {
    ...
    return (index$3.h(index$3.Host, Object.assign({ "no-router": true, "aria-modal": "true", role: "dialog", tabindex: "-1" }, htmlAttributes, inheritedAttributes, { style: {
        zIndex: `${20000 + this.overlayIndex}`,
      }, class: Object.assign({ [mode]: true, ['modal-default']: !isCardModal && !isSheetModal, [`modal-card`]: isCardModal, [`modal-sheet`]: isSheetModal, 'overlay-hidden': true }, theme.getClassMap(this.cssClass)), id: modalId, onIonBackdropTap: this.onBackdropTap, onIonModalDidPresent: this.onLifecycle, onIonModalWillPresent: this.onLifecycle, onIonModalWillDismiss: this.onLifecycle, onIonModalDidDismiss: this.onLifecycle }), index$3.h("ion-backdrop", { ref: (el) => (this.backdropEl = el), visible: this.showBackdrop, tappable: this.backdropDismiss, part: "backdrop" }), mode === 'ios' && index$3.h("div", { class: "modal-shadow" }), index$3.h("div", { class: "modal-wrapper ion-overlay-wrapper", part: "content", ref: (el) => (this.wrapperEl = el) }, showHandle && (index$3.h("button", { class: "modal-handle",
