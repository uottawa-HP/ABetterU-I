...
const getCalendarDayState = (locale, refParts, activeParts, todayParts, minParts, maxParts, dayValues) => {
  ...
  return {
    ...
    text: refParts.day != null ? parse.getDay(locale, refParts) : null,
  };
};
/**
...
const Datetime = class {
  constructor(hostRef) {
    ...
    this.setActiveParts = (parts, removeDate = false) => {
       ...
       */
      const validatedParts = parse.validateParts(parts);
      ...
      if (multiple) {
        ...
        if (removeDate) {
          this.activeParts = activePartsArray.filter((p) => !parse.isSameDay(p, validatedParts));
        }
    ...
    this.processMinParts = () => {
      ...
      this.minParts = parse.parseMinParts(min, todayParts);
    };
    this.processMaxParts = () => {
      ...
      this.maxParts = parse.parseMaxParts(max, todayParts);
    };
  ...
  renderCombinedDatePickerColumn() {
    ...
    const result = parse.getCombinedDateColumnData(locale, todayParts, min, max, this.parsedDayValues, this.parsedMonthValues);
  ...
  renderIndividualDatePickerColumns(forcePresentation) {
    ...
    const years = shouldRenderYears
      ? parse.getYearColumnData(this.locale, this.todayParts, this.minParts, this.maxParts, this.parsedYearValues)
      : [];
    /**
  ...
  renderCalendarHeader(mode) {
    ...
    return (index.h("div", { class: "calendar-header" }, index.h("div", { class: "calendar-action-buttons" }, index.h("div", { class: "calendar-month-year" }, index.h("ion-item", { button: true, detail: false, lines: "none", onClick: () => this.toggleMonthAndYearView() }, index.h("ion-label", null, parse.getMonthAndYear(this.locale, this.workingParts), ' ', index.h("ion-icon", { "aria-hidden": "true", icon: this.showMonthAndYear ? expandedIcon : collapsedIcon, lazy: false })))), index.h("div", { class: "calendar-next-prev" }, index.h("ion-buttons", null, index.h("ion-button", { "aria-label": "previous month", disabled: prevMonthDisabled, onClick: () => this.prevMonth() }, index.h("ion-icon", { "aria-hidden": "true", slot: "icon-only", icon: index$2.chevronBack, lazy: false, flipRtl: true })), index.h("ion-button", { "aria-label": "next month", disabled: nextMonthDisabled, onClick: () => this.nextMonth() }, index.h("ion-icon", { "aria-hidden": "true", slot: "icon-only", icon: index$2.chevronForward, lazy: false, flipRtl: true }))))), index.h("div", { class: "calendar-days-of-week" }, parse.getDaysOfWeek(this.locale, mode, this.firstDayOfWeek % 7).map((d) => {
